...
class MailChimp
{
    ...
    */
    ...
    public function __construct($api_key='')
    {
        ...
        $this->ci->config->load('mailchimp_config');
     ...
     * @throws \Exception
     */
    private function makeRequest($http_verb, $method, $args = array(), $timeout = 100)
    {
    ...
    public function subscribe($data){
        $list_id = $this->ci->config->item('mailchimp_default_list_id');

        $this->post("lists/".$list_id."/members", [
    ...
    public function unsubscribe($email){
        ...
        $this->delete("lists/$list_id/members/$subscriber_hash");
