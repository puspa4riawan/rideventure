 ...
 *
 * @category	MaxCMS\Core\Libraries\MaxCache
...
class Maxcache
{
	...
	/**
	 * Use MaxCache::model() or MaxCache::library() instead of this.
	 *
	 * @see MaxCache::model(), MaxCache::library()
	 * @todo Document this function's parameters.
	 * @param $property
	 * @param $method
	 * @param array $arguments
	 ...
	 *
	 * <code>
	 * $this->maxcache->write($data, 'nav_title');
	 * $this->maxcache->write($links, 'nav_links');
	 * $this->maxcache->delete_group('nav_');
	 * </code>
	 *
