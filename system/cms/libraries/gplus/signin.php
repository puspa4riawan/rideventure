 ...
 */
const CLIENT_ID = '768386432967-49sk4j8dej1habnbk2du85ppfo01a8tc.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'WspjdynyuYRSx6A-H_O6TB7i';
...
$app->get('/user', function () use ($app, $client, $plus) {
    $token = $app['session']->get('token');
