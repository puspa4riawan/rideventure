 ...
 * @package MaxCMS\Core\Modules\Settings
 */
class Module_Settings extends Module
{
	...
	public function admin_menu(&$menu)
	{
		...
		$menu['lang:cp:nav_settings'] = ADMIN_URL.'/settings';
	...
	public function install()
	{
		...
		$settings = array(
			...
			'dashboard_rss' => array(
				...
				'type' => 'text',
				'default' => 'https://www.maxcms.com/blog/rss/all.rss',
				'value' => '',
				'options' => '',
				'is_required' => 0,
				'is_gui' => 1,
			...
			'admin_url' => array(
				'title' => 'Admin URL',
				'description' => 'Customize Admin Url For Security',
				'type' => 'text',
				'default' => 'admin',
				'value' => 'admin',
				'options' => '',
