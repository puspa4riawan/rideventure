...
class Admin_layouts extends Admin_Controller
{
	...
	{
		empty($id) and redirect(ADMIN_URL.'/pages/layouts');
		...
		if ( ! $page_layout = $this->page_layouts_m->get($id))
		{
			...
			redirect(ADMIN_URL.'/pages/layouts/create');
		}
		...
		if ($this->form_validation->run())
		{
			...
			$this->maxcache->delete_all('page_layouts_m');
			...
			$this->input->post('btnAction') == 'save_exit'
				? redirect(ADMIN_URL.'/pages/layouts')
				: redirect(ADMIN_URL.'/pages/layouts/edit/'.$id);
		}
