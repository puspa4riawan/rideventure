...
<p>The &quot;Require an exact uri match&quot; field is a clever little tool that allows you to pass parameters in the url. By default MaxCMS looks for a page with
...
page you are telling MaxCMS that it is now okay if there isn't a page named Acme Widgets. It will now load Products and 'acme-widgets' will just be a parameter.
