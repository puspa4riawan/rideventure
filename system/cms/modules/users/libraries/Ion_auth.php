...
class Ion_auth
{
	...
	public function forgotten_password($identity)    //changed $email to $identity
	{
		if ( $this->ci->ion_auth_model->forgotten_password($identity) )   //changed
		{
			...
			$user->forgotten_password_code = $user->forgotten_password_code.'/email';
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $valid_email, $group_id = null, $additional_data = array(), $group_name = false)
	{
		$id = $this->ci->ion_auth_model->register($username, $password, $email, $valid_email, $group_id, $additional_data, $group_name);
