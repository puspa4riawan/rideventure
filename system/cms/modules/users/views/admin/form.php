					...
					<ul>
						...
						<?php if ($this->method == 'edit'): ?>
							<li class="even">
								...
								<div class="input">
									<?php echo form_password('old_password', '', 'id="password" autocomplete="off"') ?>
								</div>
							</li>
						<?php endif ?>
						<li class="even">
						...
						<li class="even">
							<label for="retype passwordd">
								<?php echo lang('global:retype_password') ?>
								<?php if ($this->method == 'create'): ?> <span>*</span><?php endif ?>
							</label>
							<div class="input">
								<?php echo form_password('retype_password', '', 'id="retype_password" autocomplete="off"') ?>
							</div>
						</li>
					</ul>
				</fieldset>
			...
			<div class="form_inputs" id="user-profile-fields-tab">
				...
				<fieldset>
					<ul>
						...
						<?php if ($this->method == 'edit' && isset($profile)): ?>
						<?php if ((bool)$profile->attachment) :?>
						<li>
							<label>Attachment</label>
							<div class="input">
								<button type="button" onclick=" window.location.href='<?=site_url($profile->attachment)?>'">Download</button>
							</div>
						</li>
						<?php endif; ?>
						<?php endif; ?>
