 ...
 * @package MaxCMS\Core\Modules\Users
 */
		...
		if (function_exists('group_has_role'))
		{
			if(group_has_role('users', 'admin_profile_fields'))
			{
				$info['sections'] = array(
					...
					'fields' => array(
							...
							'uri' 	=> ADMIN_URL.'/users/fields',
								'shortcuts' => array(
									'create' => array(
										'name' 	=> 'user:add_field',
										'uri' 	=> ADMIN_URL.'/users/fields/create',
										'class' => 'add'
										)
									)
								),
					...
					'register_log' => array(
							'name' 	=> 'Register Log',
							'uri' 	=> ADMIN_URL.'/users/register_log',
								'shortcuts' => array(
