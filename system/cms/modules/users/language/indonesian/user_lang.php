...
$lang['user:error_email']                      = 'Maaf, Untuk saat ini kami belum bisa mendaftarkan account anda.';
...
$lang['user:error_phone']						= 'Maaf, Untuk saat ini kami belum bisa mendaftarkan account anda.';
...
// Forgot Pass
$lang['user:forgot_incorrect']                 = "Kami belum bisa mereset password anda pada saat ini.";
...
// Verify
$lang['user:verify_success']                 = '%s users out of %s successfully verified.';
$lang['user:verify_error']                   = 'You need to select users first.';
