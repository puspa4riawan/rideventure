...
class Admin_fields extends Admin_Controller {
	...
	public function index()
	{
		$buttons = array(
			array(
				'url'		=> ADMIN_URL.'/users/fields/edit/-assign_id-', 
				'label'		=> $this->lang->line('global:edit')
			),
			array(
				'url'		=> ADMIN_URL.'/users/fields/delete/-assign_id-',
	...
	public function create()
	{
		...
		$extra['cancel_uri'] 	= ADMIN_URL.'/users/fields';

		$this->streams->cp->field_form('profiles', 'users', 'new', ADMIN_URL.'/users/fields', null, array(), true, $extra);
	}
	...
	public function delete()
	{
		...
		redirect(ADMIN_URL.'/users/fields');
	}
	...
	public function edit()
	{
		...
		$this->streams->cp->field_form('profiles', 'users', 'edit', ADMIN_URL.'/users/fields', $assign_id, array(), true, $extra);
	}
}