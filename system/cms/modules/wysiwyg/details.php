 ...
 * @package MaxCMS\Core\Modules\Widgets
 */
class Module_WYSIWYG extends Module
{
        ...
        public function info()
        {
                return array(
                    ...
                    'description' => array(
                        'en' => 'Provides the WYSIWYG editor for MaxCMS powered by CKEditor.',
						'br' => 'Provém o editor WYSIWYG para o MaxCMS fornecido pelo CKEditor.',
                        'fa' => 'ویرایشگر WYSIWYG که توسطCKEditor ارائه شده است. ',
                        'fr' => 'Fournit un éditeur WYSIWYG pour MaxCMS propulsé par CKEditor',
                        'pt' => 'Fornece o editor WYSIWYG para o MaxCMS, powered by CKEditor.',
                        'el' => 'Παρέχει τον επεξεργαστή WYSIWYG για το MaxCMS, χρησιμοποιεί το CKEDitor.',
                        'se' => 'Redigeringsmodul för HTML, CKEditor.',
                        'tw' => '提供 MaxCMS 所見即所得（WYSIWYG）編輯器，由 CKEditor 技術提供。',
                        'cn' => '提供 MaxCMS 所见即所得（WYSIWYG）编辑器，由 CKEditor 技术提供。',
                        'ar' => 'توفر المُحرّر الرسومي لـMaxCMS من خلال CKEditor.',
