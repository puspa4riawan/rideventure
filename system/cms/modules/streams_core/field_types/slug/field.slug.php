...
class Field_slug
{
	...
	public function form_output($params)
	{
		...
		$jquery = "<script>(function($) {
			$(function(){
					max.generate_slug('#{$params['custom']['slug_field']}', '#{$params['form_slug']}', '{$params['custom']['space_type']}');
			});
		})(jQuery);
		</script>";
