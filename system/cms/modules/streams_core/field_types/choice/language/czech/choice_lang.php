...
$lang['streams:choice.instructions'] 		= 'Napište každou možnost na jeden řádek. Pokud chcete oddělit hodnotu pro každou možnost, můžete použít dvojtečku (:). Např.<pre>MaxCMS'."\n".'max : MaxCMS</pre>';
