...
/**
 * MaxStreams Image Field Type
 *
 * @package		MaxCMS\Core\Modules\Streams Core\Field Types
 * @author		Parse19
 * @copyright	Copyright (c) 2011 - 2012, Parse19
 * @license		http://parse19.com/maxstreams/docs/license
 * @link		http://parse19.com/maxstreams
 */
class Field_image
{
	...
	public function param_folder($value = null)
	{
		...
		foreach ($tree as $tree_item)
		{
			...
			// with MaxStreams 1.1 and below where
