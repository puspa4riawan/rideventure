...
$lang['streams:cannot_find_maxstreams']				= "Cannot find MaxStreams.";
...
$lang['streams:start.no_fields_msg']					= "There are no fields to add to this stream. In MaxStreams, field types can be shared between streams and must be created before being added to a stream. You can start by";
