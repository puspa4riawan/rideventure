...
<section class="item">
	...
	<?php if ($themes): ?>
		...
		<?php echo form_open(ADMIN_URL.'/addons/themes/set_default') ?>
		...
		<table class="table-list" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td class="actions">
						<?php echo isset($theme->options) ? anchor(ADMIN_URL.'/addons/themes/options/'.$theme->slug, lang('addons:themes:options'), 'title="'.$theme->name.'" class="button options"') : '' ?>
						...
						<?php if($theme->slug != 'admin_theme') { echo anchor(ADMIN_URL.'/addons/themes/delete/'.$theme->slug, lang('buttons:delete'), 'class="confirm button delete"'); } ?>
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
