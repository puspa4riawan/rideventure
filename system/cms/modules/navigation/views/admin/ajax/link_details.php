<div id="details-container">
	...
	<div class="buttons">
		<?php echo anchor(ADMIN_URL.'/navigation/edit/' . $link->id, lang('global:edit'), 'rel="'.$link->navigation_group_id.'" class="button ajax"') ?>
		<?php echo anchor(ADMIN_URL.'/navigation/delete/' . $link->id, lang('global:delete'), 'class="confirm button"') ?>
	</div>
</div>