			...
			<div class="one_full">
				<section class="title files-title">
					<ul>
						...
						<li><?php echo anchor(ADMIN_URL.'/navigation/groups/delete/'.$group->id, lang('global:delete'), array('class' => 'tooltip-e confirm btn button red',  'title' => lang('nav:group_delete_confirm'))) ?></li>
						<li>
							<!-- <h4 class="form-title group-title-<?php echo $group->id ?>"></h4> -->
							<?php echo anchor(ADMIN_URL.'/navigation/create/'.$group->id, lang('nav:link_create_title'), 'rel="'.$group->id.'" class="add ajax button"') ?>
						</li>
					</ul>
