    ...
    <table class="table-list" cellspacing="0">
		...
		<?php foreach ($keywords as $keyword):?>
			<tr>
				...
				<td class="actions">
				<?php echo anchor(ADMIN_URL.'/keywords/edit/'.$keyword->id, lang('global:edit'), 'class="button edit"') ?>
				<?php if ( ! in_array($keyword->name, array('user', 'admin'))): ?>
					<?php echo anchor(ADMIN_URL.'/keywords/delete/'.$keyword->id, lang('global:delete'), 'class="confirm button delete"') ?>
				<?php endif ?>
				</td>
			</tr>
		<?php endforeach;?>
