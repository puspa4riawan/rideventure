...
if(isset($_SERVER['HTTP_HOST'])){
	...
	$config['base_url']	= 'http://sinom-tec.com';
}
...
// This is set in the maxcache config so Pro can set the correct SITE_REF
$config['cache_path'] = '';
...
|
*/
$config['encryption_key'] = '0eDquBFhvoiuE27xrFyaQfloaZlTkgy1c/DW6/FN3y';

//token api wyeth
$config['token_wyeth_api'] = '3nH899hGidhY56Mb5g98j';
...
|
*/
$config['sess_cookie_name']		= 'maxcms' . (ENVIRONMENT !== 'production' ? '_' . ENVIRONMENT : '');
// $config['sess_expiration']		= 3600; // Rubah atas permintaan 13 Desember 2017 (value lama: 600)
$config['sess_expiration']		= 1200; // Rubah atas permintaan SA 06 Februari 2018 (value lama: 3600)
...
// $config['cookie_domain']	= ($_SERVER['SERVER_NAME'] == 'localhost') ? '' : $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
...
*/
$config['csrf_protection'] 		= TRUE; //(bool) preg_match('@\/admin(\/.+)?$@', $_SERVER['REQUEST_URI']); // only turn it on for admin panel
...
|
*/
$config['minify_output'] = (ENVIRONMENT !== MAX_DEVELOPMENT); // only do this on
