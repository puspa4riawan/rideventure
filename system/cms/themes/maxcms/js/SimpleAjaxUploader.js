...
ss.SimpleUpload.prototype = {
  ...
  */
  _createInput: function() {
    ...
    ss.addStyles( div, {
      ...
      'opacity' : 0,
      'direction' : 'ltr',
      'zIndex': this._opts.customZIndex
      //'zIndex': 2147483583
    });
  ...
  */
  rerouteClicks: function( elem ) {
    ...
    setTimeout(function(){$(elem).show();},0);
  ...
  */
  submit: function() {
         ...
         this._queue.length < 1  )
    {
    	...
    	if( (typeof(this._opts.data.post_id) !='undefined' && typeof(this._opts.data.is_change) != 'undefined'))
    	{
    		return;
    	}
    	else if( (typeof(this._opts.data.post_id) =='undefined' && typeof(this._opts.data.is_change) == 'undefined')){
    		
    		return;
    	}
    	else {
    		this._queue[0] = {file:{size:0,name:'dummy.jpg','value':'dummy.jpg'},btn:this._btns}
