    ...
    <table class="table-list" border="0" cellspacing="0">
		<thead>
			<tr>
			    ...
			    <th><?php echo lang('max.actions');?></th>
			</tr>
		</thead>
		<tbody>
...
<?php else: ?>
	<div class="no_data"><?php echo lang('streams:start.no_fields');?> <?php echo anchor(isset($add_uri) ? $add_uri : ADMIN_URL.'/streams/fields/add', lang('streams:start.add_one'), 'class="add"'); ?>.</div>
<?php endif;?>
