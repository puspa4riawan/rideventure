		...
		<div id="content-body">
			...
			<?php $this->load->view('admin/partials/notices') ?>
				...
				<div class="form_inputs">
					<ul>
						<li>
							<div class="input animated fadeIn" id="login-un"><input type="text" name="email" placeholder="<?php echo lang('global:email'); ?>" autocomplete="off"/></div>
						</li>

						<li>
							<div class="input animated fadeIn" id="login-pw"><input type="password" name="password" placeholder="<?php echo lang('global:password'); ?>" autocomplete="off"/></div>
						</li>
