...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('category:add') ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('category:update'), $data_->name) ?></h4>
<?php endif ?>
</section>
        ...
        <div class="form_inputs" id="article-main-tab">
            ...
            <fieldset>
                <ul>
                    ...
                    <li>
                        <label for="title"><?php echo lang('category:title') ?> <span>*</span></label>
                        <div class="input">
                            <input type="text" id="title" name="name" size="80" value="<?php echo set_value('name', isset($data_->name) ? $data_->name : ''); ?>" />
                            <br>
                            <?php if($this->method=='edit') { ?>
                                <a href="javascript:void(0);" title="Set name as slug" class="btn green" id="set-title-slug" >Set title as slug</a>
                            <?php } ?>
                        </div>
                    </li>
                    <li>
                        <label for="slug"><?php echo lang('category:slug') ?> <span>*</span></label>
                        <div class="input">
                            <input type="text" id="slug" name="slug" size="80" value="<?php echo set_value('slug', isset($data_->slug) ? $data_->slug : ''); ?>"/>
                        </div>
                    </li>
                    <li class="editor">
                        <label for="description"><?php echo lang('category:desc') ?> </label><br>
                    ...
                    <li>
                        <label for="status"><?php echo lang('category:status_label') ?></label>
                        <div class="input"><?php echo form_dropdown('status', array('draft' => lang('category:draft_label'), 'live' => lang('category:live_label')), $data_->status) ?></div>
...
var uri_delete_info = '<?=ADMIN_URL."/category/delete_arinfo";?>';
