 ...
 */
class Admin_destinations extends Admin_Controller {

	var $u_admin 		= 'admin_destinations';
	protected $section 	= 'destinations';
	protected $module_url = 'destination';
	protected $active_table = 'destinations';
    ...
    public function __construct() {
		...
		$this->load->model(array('destinations_m'));
		$this->lang->load(array('general', 'destinations'));
		$this->load->libraries(array('upload'));

		$this->load->model('destinations_m','current_m');
	...
	public function create() {
		...
		if ($this->form_validation->run()) {
			...
			if ($id = $this->destinations_m->insert_data('destinations', $extra)) {
				if($_FILES['thumb']['name']!=''){
					...
					if($this->upload->do_upload('thumb')){
	                	...
	                	$this->destinations_m->update_data('destinations', $new_data, 'id', $id);
