 ...
 */
class Admin_armada extends Admin_Controller {

	var $u_admin 		= 'admin_armada';
	protected $section 	= 'armada';
	protected $module_url = 'armada';
	protected $active_table = 'armada';
	protected $current_model = 'armada_m';
