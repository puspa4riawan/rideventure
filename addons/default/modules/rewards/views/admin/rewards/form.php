...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('rewards:add') ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('rewards:update'), $data_->title) ?></h4>
<?php endif ?>
</section>
        ...
        <div class="form_inputs" id="article-main-tab">
            ...
            <fieldset>
                <ul>
                    ...
                    <li>
                        <label for="title"><?php echo lang('rewards:title') ?> <span>*</span></label>
                        <div class="input">
                    ...
                    <li>
                        <label for="slug"><?php echo lang('rewards:slug') ?> <span>*</span></label>
                        <div class="input">
                            <input type="text" id="slug" name="slug" size="80" value="<?php echo set_value('slug', isset($data_->slug) ? $data_->slug : ''); ?>"/>
                        </div>
                    </li>
                    <li class="editor">
                        <label for="description"><?php echo lang('rewards:desc') ?> </label><br>
                    ...
                    <li>
                        <label for="slug"><?php echo lang('rewards:show_percentage') ?> <span>*</span></label>
                        <div class="input">
                            <input type="number" id="slug" name="show_percentage" size="80" value="<?php echo set_value('show_percentage', isset($data_->show_percentage) ? $data_->show_percentage : '0'); ?>"/>
                        </div>
                    </li>
                   
                    
                    <li>
                        <label for="status"><?php echo lang('rewards:status_label') ?></label>
                        <div class="input"><?php echo form_dropdown('status', array('draft' => lang('rewards:draft_label'), 'live' => lang('rewards:live_label')), $data_->status) ?></div>
...
var uri_delete_info = '<?=ADMIN_URL."/rewards/delete_arinfo";?>';
