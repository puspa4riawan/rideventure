 ...
 */
class Admin_webcontent extends Admin_Controller {

	var $u_admin 		= 'admin_webcontent';
	protected $section 	= 'webcontent';
	protected $module_url = 'webcontent';
	protected $active_table = 'webcontent';
	protected $current_model = 'webcontent_m';
    ...
    public function __construct() {
		...
		$_template = array(
			'no-image'			=>'Web Content without image',
			'thumb' 			=>'Web Content with thumbnail',
			'2-tile' 			=>'Web Content with merge tile',
			'gallery' 			=>'Web Content with gallery',
