 ...
 */
class Admin_benner extends Admin_Controller {

	var $u_admin 		= 'admin_benner';
	protected $section 	= 'benner';
    ...
    public function __construct() {
		...
		$this->load->model(array('benner_m'));
		$this->lang->load(array('general', 'benner'));
	...
	public function index() {
		...
		$this->template
			...
			->set_partial('filters', 'admin/benner/partials/filters')
			->append_js('module::admin-article.js')
			->set('pagination', $pagination)
			->set('data_', $data_);

			$this->input->is_ajax_request()
			? $this->template->build('admin/benner/tables/table')
			: $this->template->build('admin/benner/index');
	}
