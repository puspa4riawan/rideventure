	<table cellspacing="0">
		<thead>
			<tr>
				...
				<th width="10%"><?php echo lang('benner:label_title') ?></th>
				<th width="40%"><?php echo lang('benner:desc') ?></th>
