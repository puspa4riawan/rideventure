...
class Module_product extends Module {
	...
	protected $upload_folder = array('default/files/product');
	...
	public function info() {
		...
		$info = array(
			...
			'description' => array(
				'en' => 'Product Module for post list',
				'id' => 'Modul Product untuk menampilkan list post'
			),
			...
			'sections' => array(
				'product'	=> array(
					'name'		=> 'product:title',
					'uri'		=> ADMIN_URL.'/product',
					'shortcuts'	=> array(
						array(
							'name'	=> 'product:add',
							'uri'	=> ADMIN_URL.'/product/create',
							'class'	=> 'add',
						),
					),
				),
	...
	public function install()
	{
		$product_fields = array(
        	...
        	'price'			=> array('type' => 'DECIMAL(10,2)', 'default' => 0),
