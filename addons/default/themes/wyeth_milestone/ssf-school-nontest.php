		...
		<div class="bs-container c-outer">
			<div class="row-0">
				...
				<div class="sch-result">
					<div class="btn btn-primary btn-capital">Ikuti Smart Strength Finder untuk mengetahui kepintaran anak anda <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></div>
				</div>
