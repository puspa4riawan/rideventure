  ...
  <div class="landing-imunisasi mainMargin-b">
    ...
    <div class="landing-imunisasi-wrap">
      <div class="container c-inner">
        <div class="landing-imunisasi-text" id="step04">
          ...
          <div class="landing-imunisasi-content">
            <div class="form-group">
              Apakah Mam ingat imunisasi yang diberikan kepada [Nama Anak]?
            </div>
            <div class="form-group">
              <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input">
                <span class="custom-control-indicator"></span>
                <span class="custom-control-description">Ingat</span>
              </label>
              <label class="custom-control custom-radio">
                <input id="radio2" name="radio" type="radio" class="custom-control-input">
                <span class="custom-control-indicator"></span>
                <span class="custom-control-description">Tidak ingat</span>
              </label>
            </div>
            <div class="form-group">
              <a href="vaksin-riwayat-imunisasi.php" class="btn btn-primary btn-capital btn-icon-right w-75">Lanjutkan <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
