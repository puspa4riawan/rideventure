<?php include 'partials/html-head-start.php'; ?>
	<title>Vaksin Pilih Lokasi</title>
	<!-- separate page style -->
...
<main id="mainContent">
  <section class="bg-cream mainMargin-b">
    <div class="container c-inner pt-4">
      <a href="" class="btn btn-link btn-capital btn-icon-right pl-0"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Kalender imunisasi</a>
      <hr>
    </div>

    <div class="container c-inner mainPadding">
      <div class="vaksin-section-subtitle text-emas3 text-center">
        <h2 class="text-inherit">Lokasi Imunisasi</h2>
      </div>

      <div class="vaksin-lokasi-form form-row">
        <div class="col-md-4">
          <div class="form-group">
            <label for="" class="strong small">Pilih Provinsi</label>
            <select class="bs-border-primary form-control">
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="" class="strong small">Pilih Kota</label>
            <select class="bs-border-primary form-control">
              <option>Mustard</option>
              <option>Ketchup</option>
              <option>Relish</option>
        ...
        <div class="col-md-auto">
          <div class="form-group">
            <div class="btn btn-primary btn-capital btn-wider w-100">Cari</div>            
          </div>
        </div>
      </div>
    </div>
