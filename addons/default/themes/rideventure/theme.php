...
class Theme_Rideventure extends Theme
{
    public $name			= 'Rideventure';
    public $author			= 'sinom-tec';
    public $author_website	= 'http://sinom-tec.com/';
    public $website			= 'http://sinom-tec.com/';
