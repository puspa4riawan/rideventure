 ...
 * @package 	MaxCMS\Core\Modules\API\Controllers
 */
class Admin_keys extends Admin_Controller
{
	...
	{
		$this->streams->cp->entries_table('keys', 'api', Settings::get('records_per_page'), ADMIN_URL.'/api/keys/index', true, array(
			'buttons' => array(
				array(
			        'label'     => lang('global:edit'),
			        'url'       => ADMIN_URL.'/api/keys/edit/-entry_id-',
			    ),
			    array(
			        'label'     => lang('global:delete'),
			        'url'       => ADMIN_URL.'/api/keys/delete/-entry_id-',
			        'confirm'   => true,
			    ),
			),
		));
